...
public class Insufficientfunds {
	...
	public void Connect() throws InterruptedException {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter(".//Reports//Insufficientfunds.html");
		...
		for (WebElement ava : Avail) {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".sc-clsFYl .hwaSni:nth-of-type(1)")));
			List<WebElement> Availl = driver.findElements(By.cssSelector(".sc-clsFYl .hwaSni:nth-of-type(1)"));
			...
			String AA1= "Insufficient Funds";
				 ...
				 String SS1= ball.substring(39,57);
