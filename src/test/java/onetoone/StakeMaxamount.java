...
public class StakeMaxamount {
	...
	public void Connect() throws InterruptedException {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter(".//Reports//StakeMaxamount.html");
		...
		// driver.findElement(By.cssSelector(".bsfnEV.sc-dIUeWJ
		// img[alt='close']")).click();
		...
		List<WebElement> Avail = driver.findElements(By.cssSelector("p > span"));
		...
		for (WebElement ava : Avail) {
			...
			driver.findElement(By.cssSelector(".iPHkub.sc-iWFTwQ")).click();

			driver.findElement(By.cssSelector(".dbcJDJ.sc-fybuyZ")).click();
			...
			driver.findElement(By.cssSelector("#root > div.sc-ksXiFW.bHLZxk > div.sc-dIUeWJ.bsfnEV > div > div.sc-kfzBvY.dHohrU")).click();
			
			driver.findElement(By.cssSelector("input#ethAmount")).clear();
