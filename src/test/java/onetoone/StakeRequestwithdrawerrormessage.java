...
public class StakeRequestwithdrawerrormessage {
	...
	public void Connect() throws InterruptedException {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter(".//Reports//Requestwithdrawerrormessage.html");
		...
		driver.findElement(By.cssSelector(".sc-gGTEWt.xPmKz")).click();

		Thread.sleep(1000);
		List<WebElement> Avail = driver.findElements(By.cssSelector("li:nth-of-type(1) > span"));
		...
		for (WebElement ava : Avail) {
			...
			String value = Double.toString(d4);

			driver.findElement(By.cssSelector("input#ethAmount")).sendKeys(value);
			driver.findElement(By.cssSelector(".bLmodP.sc-hJJRrs > button:nth-of-type(1)")).click();

			List<WebElement> Availl = driver.findElements(By.cssSelector(".dGcrBD.sc-hYZPxA"));
			...
			for (WebElement ava1 : Availl) {
				...
				int MM = ball.indexOf("Insufficient Funds");

				// System.out.println("Index number ==========" + MM);

				String AA1 = "Insufficient Funds";

				String SS1 = ball.substring(25, 43);

				System.out.println("Error message " + SS1);
