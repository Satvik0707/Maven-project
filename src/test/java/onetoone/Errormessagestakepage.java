...
public class Errormessagestakepage {
	...
	public void Connect() throws InterruptedException {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter(".//Reports//Errormessagestakepage.html");
		...
		List<WebElement> Availl = driver.findElements(By.cssSelector(".iHKxRR.sc-bGqPaL > .kOdOln.sc-fXtZR"));
		...
		for (WebElement ava1 : Availl) {
			...
			String SS1 = ball.substring(21, 45);
